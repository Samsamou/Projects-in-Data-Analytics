...
#Drop the columns 
credit_data <- credit_data %>%
  select(-MALE_SINGLE, -MALE_DIV, -MALE_MAR_or_WID, -MARITAL_STATUS, -TELEPHONE, -FOREIGN)
```
...
```{r}
credit_data <- credit_data %>% select(RESPONSE, CHK_ACCT, DURATION, HISTORY, AMOUNT, SAV_ACCT, EMPLOYMENT, INSTALL_RATE, GUARANTOR, OTHER_INSTALL, CREDIT_PURPOSE, HOUSING)
