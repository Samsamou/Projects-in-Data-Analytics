...
plot(svm_model_radial$finalModel)
...
predicted_probs <- predict(gbm_model, newdata = test_data, type = "prob")[,2]

# Create the ROC curve
roc_obj <- roc(test_data$RESPONSE, predicted_probs)

# Plot the ROC curve
plot(roc_obj, main="ROC Curve for the Gradient Boosting Model")
```
...
# Plot the ROC curve
plot(roc_obj, main="ROC Curve for the second XGBoost Model")
```
